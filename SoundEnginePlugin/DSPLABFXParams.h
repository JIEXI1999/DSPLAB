...
#ifndef DSPLABFXParams_H
#define DSPLABFXParams_H
...
struct DSPLABFXParams
    : public AK::IAkPluginParam
{
    DSPLABFXParams();
    DSPLABFXParams(const DSPLABFXParams& in_rParams);
    ...
    DSPLABRTPCParams RTPC;
    DSPLABNonRTPCParams NonRTPC;
};

#endif // DSPLABFXParams_H
